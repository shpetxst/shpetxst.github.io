...
export default function OfficersPage() {
  const officers = [
    ...
    { name: "Jorge Jimenez", position: "Treasurer Assistant", major:"Major in Computer Science", class:"Class of '26", image: "/assets/images/headshots/bobcat.png?height=200&width=200" },
    ...
    { name: "Noemy Cerevantes", position: "SHPEtinas Director", major:"Major in Computer Science", class:"Class of '25", image: "/assets/images/headshots/Noemy_headshot.jpg?height=200&width=200" },
