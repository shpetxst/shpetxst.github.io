...
export default function SHPEtinasPage() {
  ...
  const events: Event[] = [
    { name: 'SHPEtinas Meet and Greet at Sewell Park', date: 'September 7, 2024', image: '/assets/images/SHPEtinas_events/SHPEtinas_sewell.jpg?height=200&width=200' },
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {boardMembers.map((member, index) => (
                <div key={index} className="bg-white p-6 rounded-lg shadow text-center">
                  <img src={member.image} alt={member.name} className="w-60 h-60 rounded-full mx-auto mb-4" />
